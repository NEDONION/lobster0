...
from lobster0.gateway_service import ServiceError, ServiceStatus
...
def start_soak(
    ...
    *,
    ...
    Args:
        ...
        state_home: 本次绑定的 Lobster0 state home。
...
def _atomic_replace(path: Path, payload: bytes, error_code: str) -> None:
    ...
    try:
        descriptor, name = tempfile.mkstemp(prefix=".lobster0-soak-", dir=path.parent)
        temporary = Path(name)
