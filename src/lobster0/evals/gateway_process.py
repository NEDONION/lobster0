...
class ManagedGateway:
    ...
    async def start(
        ...
        *,
        ...
        """启动当前 Python 的 Lobster0，并等待精确平台 ready marker。

        Args:
            project_root: 子进程使用的绝对 clean worktree。
            home: 传给 Lobster0 CLI 的绝对状态目录。
            ...
            command: 测试专用 exact argv；省略时启动当前 Lobster0 module。
        ...
        environment["LOBSTER0_GATEWAY_COMMIT"] = commit
