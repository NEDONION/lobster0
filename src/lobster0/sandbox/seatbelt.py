...
from lobster0.sandbox.docker import _rebind_receipt
from lobster0.sandbox.executables import verify_executable_chain
from lobster0.sandbox.host import EnvironmentResolver, HostSandbox
...
class SeatbeltSandbox:
    ...
    async def execute(self, plan: ExecutionPlan) -> ExecutionReceipt:
        ...
        descriptor, profile_name = tempfile.mkstemp(prefix="lobster0-seatbelt-", suffix=".sb")
