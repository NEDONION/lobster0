...
class FeishuConfig:
    ...
    app_id_env: str = "LOBSTER0_FEISHU_APP_ID"
    app_secret_env: str = "LOBSTER0_FEISHU_APP_SECRET"
    domain: str = "feishu"
    owner_open_id: str = ""
...
def load_config(
    ...
    hard_budget_is_explicit = (
        ...
        or "LOBSTER0_MAX_TOOL_ITERATIONS_HARD" in source
    )
    ...
    feishu_app_id_env = _environment_variable_name(
        feishu_raw.get("app_id_env", "LOBSTER0_FEISHU_APP_ID"),
        "channels.feishu.app_id_env",
    )
    feishu_app_secret_env = _environment_variable_name(
        feishu_raw.get("app_secret_env", "LOBSTER0_FEISHU_APP_SECRET"),
    ...
    telegram_bot_token_env = _environment_variable_name(
        telegram_raw.get("bot_token_env", "LOBSTER0_TELEGRAM_BOT_TOKEN"),
    ...
    discord_bot_token_env = _environment_variable_name(
        discord_raw.get("bot_token_env", "LOBSTER0_DISCORD_BOT_TOKEN"),
    ...
    sandbox_image = _sandbox_image(
        sandbox_raw.get("image", "lobster0-sandbox:phase6"), "sandbox.image"
    )
    if (
        automation_enabled
    ...
    browser_profile = _enum_string(
        browser_raw.get("profile", "lobster0"),
        "browser.profile",
        frozenset({"lobster0", "personal"}),
    )
    ...
    max_tool_iterations = _environment_integer(
        source, "LOBSTER0_MAX_TOOL_ITERATIONS", max_tool_iterations
    )
    ...
    tool_result_max_chars = _environment_integer(
        source, "LOBSTER0_TOOL_RESULT_MAX_CHARS", tool_result_max_chars
    )
    base_url = _environment_url(source, "LOBSTER0_MODEL_BASE_URL", base_url)
    api_key_env = _environment_name(
        source, "LOBSTER0_MODEL_API_KEY_ENV", api_key_env
    )
    timeout_seconds = _environment_integer(
        source, "LOBSTER0_MODEL_TIMEOUT_SECONDS", timeout_seconds
    )
    workspace_path = _environment_path(source, "LOBSTER0_WORKSPACE", workspace_path)
