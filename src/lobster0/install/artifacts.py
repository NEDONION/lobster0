...
_RELEASES_API_URL = "https://api.github.com/repos/NEDONION/lobster0/releases?per_page=20"
_GITHUB_RELEASE_PREFIX = "/NEDONION/lobster0/releases/"
    ...
    for redirect_count in range(_MAX_REDIRECTS + 1):
        ...
        request = Request(
            ...
            headers={
                ...
                "User-Agent": "lobster0-installer/0.7",
            },
            method="GET",
        )
        try:
