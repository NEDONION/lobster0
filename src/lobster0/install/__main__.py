...
from lobster0.install.models import InstallError, InstallEvent, InstallRequest
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = _Parser(
        prog="lobster0-installer.pyz",
        description="Lobster0 trusted one-line installer",
    )
...
def _request(arguments: argparse.Namespace, stdin_isatty: bool) -> InstallRequest:
    ...
    if arguments.home:
        ...
        state_home = Path(_invoking_account().pw_dir) / ".lobster0"
    else:
        state_home = Path.home() / ".lobster0"
