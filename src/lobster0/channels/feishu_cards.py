...
from lobster0.channels.progress import AgentProgress, ProgressStatus, ProgressStep
...
def render_compact_progress(progress: AgentProgress) -> str:
    ...
    lines = [f"Lobster0 · {_status_label(progress.status)}", progress.summary, "", "Claw Trail"]
