"""读取和经审批追加 MiniClaw Markdown Memory 的 Tool。"""
...
class ReadMemoryTool:
    ...
    definition = ToolDefinition(
        name="read_memory",
        description=(
            "Read MiniClaw's bounded Markdown memory. Use long_term for durable facts, "
...
class ProposeMemoryTool:
    ...
    definition = ToolDefinition(
        name="propose_memory",
        description=(
            "Propose one durable fact for today's MiniClaw memory. Use only when the owner "
