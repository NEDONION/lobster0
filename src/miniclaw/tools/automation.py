...
from miniclaw.automation.parser import ScheduleError, parse_schedule
from miniclaw.automation.repository import (
    AutomationStateError,
    ScheduledTaskRepository,
    TaskRunRepository,
)
from miniclaw.config import ChannelConfig
...
class ManageTaskTool:
    ...
    definition = ToolDefinition(
        ...
        description=(
            ...
            "MiniClaw automation task. Never include credentials in task prompts."
        ),
        parameters={
            "type": "object",
            "properties": {
