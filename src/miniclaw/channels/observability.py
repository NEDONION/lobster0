...
class ChannelObserver:
    ...
    def __init__(
        ...
        *,
        ...
        self._logger = logger or logging.getLogger("miniclaw.channel")
    ...
    def correlation_id(channel: str, account_id: str, external_message_id: str) -> str:
        ...
        source = f"miniclaw-channel-v1\0{channel}\0{account_id}\0{external_message_id}"
