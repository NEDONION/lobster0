...
from miniclaw.automation.guard import AutomationGuardError, AutomationPromptGuard
...
from miniclaw.storage.tooling import ApprovalRepository, StoredApproval
...
async def run_automation_case(case: EvalCase) -> AutomationCaseResult:
    ...
    try:
        ...
        with TemporaryDirectory(prefix="miniclaw-automation-eval-") as directory:
