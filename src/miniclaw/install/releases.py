...
from miniclaw.install.artifacts import _Opener, _read_bounded_url
from miniclaw.install.models import InstallError, _parse_semver
...
class ReleaseSource:
    ...
    Args:
        ...
        manifest_url: exact MiniClaw GitHub Release manifest URL。
