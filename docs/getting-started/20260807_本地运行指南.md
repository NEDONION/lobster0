...
尚未支持：NVM/Node 路径下 `lark-cli` 的真实 smoke、飞书/Telegram/Discord Channel、向量检索与自动演进。
...
当前基线：**318/318 Python tests、25/25 TypeScript tests、24/24 active offline Agent cases、Ruff PASS**。
