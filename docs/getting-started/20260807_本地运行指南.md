...
[飞书 Gateway 运行时与 macOS 常驻](../engineering/phase-5/feishu-gateway-runtime-and-macos-service.md)记录了本次
...
当前门禁规模：**IMPLEMENTATION PASS**；556/556 Python tests、30/30 TypeScript tests、29/29 active offline Agent
...
Phase 5 三平台运行细节见
[Telegram/Discord 工程说明](../engineering/phase-5/telegram-discord-channels.md)、
[真实飞书 Bot 与 Live E2E](../engineering/phase-5/feishu-live-e2e.md)、
[测试与 live acceptance](../engineering/phase-5/testing-and-live-acceptance.md)和
[故障排查手册](../engineering/phase-5/troubleshooting.md)。
