...
| [Phase 2：回归、恢复与调试](phase-2/testing-and-debugging.md) | 当前 508 Python + 27 TypeScript tests、28 Agent + 32 Channel 场景、恢复、Doctor 和发布手册。 | 三平台真实 E2E、自动 Prompt/Skill 演进。 |
...
功能主线已完成 Phase 5 implementation（508 Python tests + 27 TypeScript tests + 28/28 Agent + 32/32 Channel）。
...
| [测试与 live acceptance](phase-5/testing-and-live-acceptance.md) | 508 Python、27 TypeScript、28 Agent、32 Channel、640 soak、三平台 live gate。 | 三个平台真实 evidence。 |
...
Phase 5 当前是 **IMPLEMENTATION PASS**：508 Python tests、27/27 TypeScript、28/28 Agent、32/32 Channel 与
