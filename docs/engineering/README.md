...
| Phase 3 | Memory v1、Skills、Compaction | v0.3.0 | `CURRENT` | [Memory、Skills 与上下文压缩](phase-3/20260808_memory-skills-compaction.md) |
...
| 文档 | 当前实现 | 明确不包含 |
| --- | --- | --- |
| [Memory、Skills 与上下文压缩](phase-3/20260808_memory-skills-compaction.md) | Markdown Memory、审批写入、凭据过滤、Skill 惰性正文、persistent compaction。 | 自动跨渠道召回、周期 Flush、晋升/冲突/遗忘治理。 |
...
| [Memory Autopilot 技术选型](20260808_memory-autopilot-best-practices-and-technology-selection.md) | Markdown Truth + SQLite Control Plane、FTS5/CJK、Crash Recovery。 | `APPROVED DESIGN / NOT IMPLEMENTED`。 |
