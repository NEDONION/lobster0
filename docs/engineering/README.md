...
| [Phase 2：回归、恢复与调试](phase-2/testing-and-debugging.md) | 当前 376 Python + 25 TypeScript tests、24 场景、stale-run recovery、Doctor、历史 live smoke 和发布手册。 | 飞书 E2E、soak、自动 Prompt/Skill 演进。 |
...
功能主线已验证到 Phase 3（全仓 376 Python + 25 TypeScript tests + 24/24 Agent cases），默认 pi-tui、
