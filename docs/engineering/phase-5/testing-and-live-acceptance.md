...
>
> 自动化证据：508 Python tests（本轮最终 fresh gate 见 v0.5.1）、27/27 TypeScript tests、28/28 offline Agent cases、
...
| Gate | Result |
| --- | ---: |
| Python | 508 tests；最终新鲜结果记录到 v0.5.1 |
...
```mermaid
flowchart TD
    A["508 Python + 27 TypeScript"] --> B["28 Agent + 32 Channel"]
