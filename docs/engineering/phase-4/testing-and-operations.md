...
> 当前门禁：412/412 Python、27/27 TypeScript、Agent 28/28、Channel 12/12、20 轮 local soak 240/240、Ruff PASS。
...
必须得到 Python 412/412、TypeScript 27/27、Agent 28/28、Channel 12/12。以后新增测试时数字应上调，不能为了
保持文档旧数字删除测试。
