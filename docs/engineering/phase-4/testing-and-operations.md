...
> 当前门禁规模：508 Python tests、27/27 TypeScript、Agent 28/28、Channel 32/32、20 轮 local soak 640/640。
...
当前 suite 规模是 Python 508、TypeScript 27、Agent 28、Channel 32。以后新增测试时数字应上调，不能为了
保持文档旧数字删除测试。
...
截至 2026-08-08，Phase 4 Core、Gateway、脱敏结构化日志/Audit、508 Python tests、27 TypeScript tests、28 条
