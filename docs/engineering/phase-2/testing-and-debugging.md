...
>
> 当前 Phase 5.3 全仓基线：556/556 Python tests、30/30 TypeScript tests、29/29 offline Agent cases、32/32 Channel cases、Ruff PASS；历史 PTY smoke PASS
>
...
- [x] 556/556 Python tests + 30/30 TypeScript tests；
