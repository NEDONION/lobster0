...
>
> 当前 Phase 5.2 全仓基线：531/531 Python tests、30/30 TypeScript tests、29/29 offline Agent cases、32/32 Channel cases、Ruff PASS；历史 PTY smoke PASS
>
...
因此发布门禁分层运行，而不是把所有风险都压给一次真实模型聊天。
...
- offline 与 channel 必须各自 100% PASS，不允许 skipped；
- diff check 无空白错误；
...
- [x] 531/531 Python tests + 30/30 TypeScript tests；
