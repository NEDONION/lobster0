...
>
> 当前单入口 TUI 基线：258/258 tests、21/21 offline Agent cases、Ruff PASS、真实 PTY smoke PASS
>
...
```mermaid
flowchart TB
    UNIT["Layer 1: 258 deterministic tests"] --> OFFLINE["Layer 2: 21 versioned Agent cases"]
