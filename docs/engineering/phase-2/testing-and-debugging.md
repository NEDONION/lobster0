...
>
> 当前 Phase 5.1 全仓基线：520/520 Python tests、30/30 TypeScript tests、28/28 offline Agent cases、32/32 Channel cases、Ruff PASS；历史 PTY smoke PASS
>
...
- [x] 520/520 Python tests + 30/30 TypeScript tests；
