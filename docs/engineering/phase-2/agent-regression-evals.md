...
>
> 当前仓库事实：258/258 tests、21/21 active offline cases、Ruff PASS；v0.1.0 发布时基线为 177 tests
>
...
当前仓库已验证结果是 258/258 tests、21/21 active cases 和 Ruff PASS。场景集首次发布时的 177 tests
