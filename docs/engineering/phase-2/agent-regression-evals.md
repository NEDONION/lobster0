...
>
> 当前仓库事实：295/295 Python tests、25/25 TypeScript tests、21/21 active offline cases、Ruff PASS
>
...
| 层 | 当前状态 | 运行时机 | 通过规则 |
| --- | --- | --- | --- |
| L0 单元/契约 | 已实现 | 每次提交 | 295/295 Python + 25/25 TypeScript |
...
当前仓库已验证结果是 295/295 Python tests、25/25 TypeScript tests、21/21 active cases 和 Ruff PASS。场景集首次发布时的 177 tests
