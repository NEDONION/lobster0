...
>
> 当前仓库事实：221/221 tests、10/10 active offline cases、Ruff PASS；v0.1.0 发布时基线为 177 tests
>
...
当前仓库已验证结果是 221/221 tests、10/10 active cases 和 Ruff PASS。场景集首次发布时的 177 tests
