...
>
> 当前仓库事实：531/531 Python tests、30/30 TypeScript tests、29/29 active offline Agent cases、32/32 Channel cases、Ruff PASS；v0.1.0 发布时基线为 177 tests
>
...
| 层 | 当前状态 | 运行时机 | 通过规则 |
| --- | --- | --- | --- |
| L0 单元/契约 | 已实现 | 每次提交 | 531/531 Python + 30/30 TypeScript |
...
当前仓库已验证结果是 531/531 Python tests、30/30 TypeScript tests、29/29 active Agent cases、32/32 Channel cases 和 Ruff PASS。场景集首次发布时的 177 tests
