...
>
> 当前仓库事实：387/387 Python tests、25/25 TypeScript tests、24/24 active offline Agent cases、12/12 Channel cases、Ruff PASS；v0.1.0 发布时基线为 177 tests
>
...
| 层 | 当前状态 | 运行时机 | 通过规则 |
| --- | --- | --- | --- |
| L0 单元/契约 | 已实现 | 每次提交 | 387/387 Python + 25/25 TypeScript |
...
当前仓库已验证结果是 387/387 Python tests、25/25 TypeScript tests、24/24 active Agent cases、12/12 Channel cases 和 Ruff PASS。场景集首次发布时的 177 tests
