...
>
> 当前仓库门禁规模：508 Python tests、27/27 TypeScript tests、28/28 active offline Agent cases、32/32 Channel cases；v0.1.0 发布时基线为 177 tests
>
...
| 层 | 当前状态 | 运行时机 | 通过规则 |
| --- | --- | --- | --- |
| L0 单元/契约 | 已实现 | 每次提交 | 508 Python + 27/27 TypeScript |
...
当前仓库门禁规模是 508 Python tests、27/27 TypeScript tests、28/28 active Agent cases、32/32 Channel cases。场景集首次发布时的 177 tests
