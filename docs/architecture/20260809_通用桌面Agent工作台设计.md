...
> 当前事实基线：`main@ed117de`；没有 Desktop 实现
...
- `desktop/` package、Electron 安装包和签名；
- 首页、任务工作台、自动化和设置界面；
- Desktop 会话查询、Artifact 列表和安全预览协议；
- Desktop 崩溃恢复、更新和三平台发布；
...
### W2：通用 Artifact 与 Automation

- 安全 Artifact 列表、预览和系统打开；
- 报告、数据、PPTX 和代码文件使用统一 Artifact 模型；
- 自动化界面消费现有 Scheduler/Run Ledger。
