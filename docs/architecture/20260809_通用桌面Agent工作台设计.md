...
Lobster0 Desktop 定位为单用户、本地优先的通用 Agent 工作台：用户用自然语言提交任务，观察执行、处理审批，
...
> Lobster0 Desktop 是让用户提交、监督和接收真实工作结果的本地通用 Agent 工作台。
...
- Vite；
- Tailwind CSS；
- Lobster0 Python Bridge Sidecar。
