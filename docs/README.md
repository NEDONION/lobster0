...
7. 阅读 [Python Core + pi-tui Bridge](engineering/phase-2/python-core-pi-tui-bridge.md)，理解版本化协议、
...
14. 阅读 [真实飞书 Bot 与 Live E2E](engineering/phase-5/feishu-live-e2e.md)，按图完成 Scope、同应用 Owner
