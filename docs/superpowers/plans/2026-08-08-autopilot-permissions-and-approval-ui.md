...
- [ ] **Step 3: 实现最小 PermissionState 与 Policy**
...
- [ ] **Step 2: 写 `/permissions` Channel 失败测试**
...
- [ ] **Step 5: 运行 GREEN 和 Channel 相关测试**
...
- [ ] **Step 5: 更新本机 Owner 配置并做真实 doctor smoke**
