...
- 产品工作名：MiniClaw
- 版本：PRD v0.1
- 状态：开发中（Phase 4 代码与离线门禁完成；真实飞书账号验收待凭据；Evolution 与部署尚未开始）
- 日期：2026-08-07
...
当前阶段证据：412/412 Python tests、27/27 TypeScript tests、28/28 active offline Agent cases 与 12/12 Feishu Channel cases 通过；
