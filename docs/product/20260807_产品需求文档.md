...
- 产品工作名：MiniClaw
- 版本：PRD v0.1
- 状态：开发中（Phase 5.3 **IMPLEMENTATION PASS**；Feishu **TARGETED CALLBACK LIVE VERIFIED /
...
当前阶段证据：Phase 5.3 **IMPLEMENTATION PASS**；556/556 Python tests、30/30 TypeScript tests、29/29 active
...
- Card callback 必须绑定 sent receipt、账号与 Approval ID；Channel notice 不得进入 Provider Context。
