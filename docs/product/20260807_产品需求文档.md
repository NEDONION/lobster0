...
- 产品工作名：MiniClaw
- 版本：PRD v0.1
- 状态：开发中（Phase 2/3 与默认 pi-tui 已完成；Phase 4 飞书 Channel Core 已实现，gateway CLI 与真实 E2E 待完成）
- 日期：2026-08-07
...
durable Inbox/Outbox、官方 WebSocket Transport 和卡片审批已实现；`gateway` CLI、真实账号 E2E 与部署仍是
...
当前阶段证据：369/369 Python、25/25 TypeScript 确定性测试与 24/24 active offline Agent cases 通过；这证明本地 Agent Core/TUI、
