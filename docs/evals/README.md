...
```mermaid
flowchart LR
    CHANGE["代码或 Prompt 变更"] --> UNIT["556 Python + 30 TypeScript"]
    UNIT --> VALIDATE["eval validate"]
    VALIDATE --> OFFLINE["29 active offline cases"]
...
当前 Phase 5.3 门禁是 **IMPLEMENTATION PASS**：556/556 Python tests、30/30 TypeScript、29/29 active offline Agent、
...
- [v0.5.3：Phase 5.3 Feishu Card callback hardening](releases/v0.5.3.md)
