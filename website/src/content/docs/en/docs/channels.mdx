---
title: Surfaces
description: How TUI, Feishu, Telegram, and Discord connect to the same MiniClaw core.
sidebar:
  order: 5
---
...
2. Add the target platform credentials to local `.env` configuration; never commit a real secret.
