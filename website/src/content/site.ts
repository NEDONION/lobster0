  ...
  en: {
    ...
    capabilities: [
      ...
      },
      {
        ...
        facts: ['Disabled by default', 'Still passes Policy', 'Explicit authorization gate', 'Can be switched off'],
      },
    ],
    workbench: {
  ...
  ja: {
    ...
    capabilities: [
      ...
      },
      {
        ...
        facts: ['既定で無効', '発火前も Policy を通過', '明示的な認可ゲート', 'いつでも無効化できる'],
      },
    ],
    workbench: {
      eyebrow: '動作の仕組み / 03',
  ...
  ko: {
    ...
    capabilities: [
      ...
      },
      {
        ...
        facts: ['기본 비활성화', '실행 전에도 Policy 통과', '명시적 인가 게이트', '언제든 끌 수 있음'],
      },
    ],
    workbench: {
      eyebrow: '동작 방식 / 03',
  ...
  fr: {
    ...
    capabilities: [
      ...
      },
      {
        ...
        facts: ['Désactivée par défaut', 'Passe toujours par Policy', 'Porte d’autorisation explicite', 'Désactivable à tout moment'],
      },
    ],
    workbench: {
